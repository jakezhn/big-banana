...
| Planner / Agent | planner quality iteration loop | 已开始 | 75% | 已具备 replay batch / summary / quality report / baseline comparison / archived report compare 工具；后续待补 review labels、prompt/version 结果解读与稳定跑数流程 |
